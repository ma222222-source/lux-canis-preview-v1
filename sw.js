const CACHE = 'lux-canis-v15';
const CORE = ['./','./index.html','./styles.css','./home-v2.css','./script.js','./product.html','./product.css','./product-enhancements.css','./product.js','./account.html','./account.css','./account-polish.css','./visibility.css','./account.js','./contact.html','./contact.css','./contact.js','./guide.html','./guide.css','./privacy.html','./privacy.css','./icon.svg','./assets/lux-canis-logo.jpg','./manifest.webmanifest'];
